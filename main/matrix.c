...
const gpio_num_t MATRIX_ROWS_PINS[] = {GPIO_NUM_15,GPIO_NUM_2,GPIO_NUM_4,GPIO_NUM_12};
const gpio_num_t MATRIX_COLS_PINS[] = { GPIO_NUM_25,GPIO_NUM_26,GPIO_NUM_27,GPIO_NUM_14 };
